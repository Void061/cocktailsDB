    ...
    return(
        <div style={{ backgroundImage: 'url('+image+')', backgroundRepeat: 'no-repeat', backgroundPosition: 'center', backgroundSize: 'cover'}} className=" relative p-8 rounded-[10px] min-h-[300px] flex w-[300px] h-[300px]">            
                ...
                <div className="w-full flex justify-between">
                    ...
                    <div onClick={handleFavorites} className="bg-[white] w-[40px] cursor-pointer h-[40px] flex justify-center items-center rounded-[50%] shadow-lg z-[9] "><svg  width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="max-w-[20px] max-h-[20px] scale-[1]">
